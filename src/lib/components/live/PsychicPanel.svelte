...
<div
	class="fixed inset-x-4 bottom-20 z-[70] mx-auto max-w-2xl rounded-md border border-neutral-800 bg-neutral-950/90 p-5 shadow-2xl backdrop-blur"
>
	{#if isPsychic}
		...
		<textarea
			bind:value={clue}
			maxlength="200"
			class="mt-4 min-h-24 w-full rounded-md border border-neutral-800 bg-black/40 p-3 text-white transition outline-none focus:border-[rgb(var(--primary))]"
	...
	{:else}
		...
		<h1 class="mt-2 text-2xl font-bold text-white">Waiting for the clue</h1>
